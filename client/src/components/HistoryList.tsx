...
import { Calendar, Wallet, PiggyBank, TrendingUp } from "lucide-react";
...
export function HistoryList() {
  ...
  return (
    <div className="w-full space-y-4 max-h-[520px] overflow-y-auto pr-2 scrollbar-thin">
      {sorted.map((calc, idx) => {
        ...
        const savingsRate =
          calc.income > 0 ? Math.max(0, Math.round((disposableIncome / calc.income) * 100)) : 0;
